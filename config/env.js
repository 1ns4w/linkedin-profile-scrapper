export const XPATH_SECTION = (sectionName) => `//section[./div[@id="${sectionName}"]]/div[3]`;
...
export const XPATH_WORK_EXPERIENCE_RETURN_CLUE = "//button[contains(@aria-label, 'Volver')]"
export const XPATH_WORK_EXPERIENCE_DROPDOWN_CLUE = "./div/a"